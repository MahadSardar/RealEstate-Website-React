...
const Testimonails = () => {
  return (
    <motion.div
        ...
        viewport={{once:true}}
     className='container mx-auto py-12 lg:px-32 w-full overflow-hidden' id='Testimonials'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='underline underline-offset-4 decoration-2 under font-light'>Testimonails</span></h1>
